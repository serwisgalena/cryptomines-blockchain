...
class CATWallet:
    ...
    def default_wallet_name_for_unknown_cat(limitations_program_hash_hex: str) -> str:
        return f"Token {limitations_program_hash_hex[:16]}..."
    ...
    async def create_new_cat_wallet(
        ...
        # If the new token name wasn't originally provided, we used a temporary name before issuance
        # since we didn't yet know the limiter. Now we know the limiter, we can update the name
        # according to the template name for unknown/new tokens.
    ...
    async def create_tandem_xch_tx(
        ...
        """
        This function creates a non-token transaction to pay fees, contribute funds for issuance, and absorb melt value.
