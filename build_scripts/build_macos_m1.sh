...
if [ "$NOTARIZE" ]; then
  electron-osx-sign Cryptomines-darwin-arm64/Cryptomines.app --platform=darwin \
...
mv Cryptomines-darwin-arm64 ../../../build_scripts/dist/
cd ../../../build_scripts || exit

DMG_NAME="Cryptomines-$CRYPTOMINES_INSTALLER_VERSION-arm64.dmg"
echo "Create $DMG_NAME"
mkdir final_installer
NODE_PATH=./npm_macos_m1/node_modules node build_dmg.js dist/Cryptomines-darwin-arm64/Cryptomines.app $CRYPTOMINES_INSTALLER_VERSION-arm64
LAST_EXIT_CODE=$?
if [ "$LAST_EXIT_CODE" -ne 0 ]; then
